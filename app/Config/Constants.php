...
defined('MOVED_PERMANENTLY')      or define("MOVED_PERMANENTLY", 301);
defined('FOUND')                  or define("FOUND", 302);
defined('SEE_OTHER')              or define("SEE_OTHER", 303);
defined('NOT_MODIFIED')           or define("NOT_MODIFIED", 304);
defined('TEMPORARY_REDIRECT')     or define("TEMPORARY_REDIRECT", 307);
...
defined('PRECONDITION_FAILED')    or define("PRECONDITION_FAILED", 412);
defined('UNSUPPORTED_MEDIA_TYPE') or define("UNSUPPORTED_MEDIA_TYPE", 415);
defined('INTERNAL_SERVER_ERROR')  or define("INTERNAL_ERROR_SERVER", 500);
 ...
 * 
 */
defined('BASE_URL_API') or define(
    "BASE_URL_API",
